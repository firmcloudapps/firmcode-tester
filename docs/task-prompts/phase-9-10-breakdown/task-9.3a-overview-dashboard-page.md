...
Code context requirement: Before implementing, inspect existing dashboard shell, overview route if present, shared review/repository DTOs, API modules, tests, Tailwind tokens, and Clerk-gated layout patterns.
...
- Add Clerk-authenticated access coverage if the route is gated at this layer.
