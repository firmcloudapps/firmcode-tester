...
Implement /repositories/:id as a Clerk-authenticated repository detail surface with Overview, Pull Requests, Findings, Configuration, and Activity tabs. The page must verify workspace ownership, show 404 or denied states for missing/cross-workspace repositories according to existing conventions, and keep configuration controls role-aware.
