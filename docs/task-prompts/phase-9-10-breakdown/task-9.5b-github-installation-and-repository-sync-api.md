...
- Add spoofed-header tests proving OAuth and sync operations cannot impersonate another Clerk user.
...
- API identity comes from verified Clerk token context.
